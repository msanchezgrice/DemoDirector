        ...
        <div className="flex gap-3">
            ...
            <button 
                ...
                className={`text-sm px-4 py-2 rounded-lg flex items-center gap-2 font-medium transition-colors ${
                    hasSaved ? 'bg-green-600/20 text-green-400 cursor-default' : 'bg-slate-800 hover:bg-slate-700 text-white'
                }`}
            >
                {hasSaved ? 'Saved' : <Icons.Save />}
            </button>
            <button 
                onClick={onRestart}
                        ...
                        >
                            <div className="flex justify-between items-center mb-1">
                                <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded uppercase ${
                                    event.type === 'zoom' ? 'bg-purple-500/20 text-purple-300' : 'bg-blue-500/20 text-blue-300'
                                }`}>
                                    {event.type}
                                </span>
